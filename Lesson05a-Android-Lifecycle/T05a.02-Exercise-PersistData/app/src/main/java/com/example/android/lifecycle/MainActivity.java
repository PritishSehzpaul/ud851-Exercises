...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String LIFECYCLE_CALLBACKS_TEXT_KEY = "callbacksKey";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
            if(savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY)){
                String previousData = savedInstanceState.getString(LIFECYCLE_CALLBACKS_TEXT_KEY);
                mLifecycleDisplay.setText(previousData);
            }
        }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String previousData = mLifecycleDisplay.getText().toString();
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY, previousData);
    }
