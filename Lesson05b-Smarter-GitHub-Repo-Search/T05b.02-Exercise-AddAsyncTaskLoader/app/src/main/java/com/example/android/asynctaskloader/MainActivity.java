...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String>{
    ...
    private void makeGithubSearchQuery() {
        ...
        if(githubQuery == null || githubQuery.isEmpty()){
            mUrlDisplayTextView.setText("Empty Search Query");
            return;
        }
        else{
            showJsonDataView();
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String>(this){
            ...
            public String loadInBackground() {
                String githubSearchQueryString = args.getString(SEARCH_QUERY_URL_EXTRA);
                if(githubSearchQueryString==null || githubSearchQueryString.isEmpty()){
                    return null;
                }
                try {
                    URL githubURL = new URL(githubSearchQueryString);
    ...
    public void onLoadFinished(Loader<String> loader, String data) {
        ...
        if (data != null && !data.equals("")) {     //data is similar to githubSearchResults
            showJsonDataView();
