...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        loadSizeMultiplierFromPreferences(sharedPreferences);
    ...
    private void loadSizeMultiplierFromPreferences(SharedPreferences sharedPreferences) {
        float multiplier = Float.parseFloat(sharedPreferences.getString(
                getString(R.string.pref_size_multiplier_key), getString(R.string.pref_size_multiplier_default)));
        mVisualizerView.setMinSizeScale(multiplier);
    }
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(getString(R.string.pref_show_bass_key))) {
            ...
            loadColorFromPreferences(sharedPreferences);
        } else if (key.equals(getString(R.string.pref_size_multiplier_key))) {
            loadSizeMultiplierFromPreferences(sharedPreferences);
        }
    }
